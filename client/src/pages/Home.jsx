...
import "./Home.css";
import QuizCategory from "../components/Carousels/QuizCategory";

const CarouselCategoryImages = [
  General,
  History,
  Games,
  TVMovies,
...
const Home = () => {
  ...
  const quizArray = data?.getQuizzes || {};
  console.log("quizzes", quizArray);

  function get_random(list) {
    return list[Math.floor(Math.random() * list.length)];
  }

  const quizIds = quizArray.map((quiz) => quiz._id);
